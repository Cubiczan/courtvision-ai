# CHP State Machine — courtvision-ai

## Protocol: Consensus Hardening Protocol (CHP) v1.0
## Domain: Blockchain / Prediction Markets
## Applied: 2026-07-03
...
### State Transitions
- EXPLORING → PROVISIONAL: Foundation score ≥ 85
- EXPLORING → REFRAME_REQUIRED: Foundation score < 85
- PROVISIONAL → PROVISIONAL_LOCK: Devil's advocate complete, no outstanding structural vulnerabilities
- PROVISIONAL_LOCK → LOCKED: Third-party CONFIRM received
- PROVISIONAL_LOCK → EXPLORING: Third-party REJECT with flip_criteria
- LOCKED → CONVERGED: Cross-agent consensus achieved
- Any → HALT: R0 gate fatal or on-chain irreversibility risk unmitigated
